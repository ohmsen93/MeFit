...
const ExerciseSelectionList = props => {
    ...
    return (
        <div className="d-flex flex-column flex-fill align-items-center border wp-100 hp-100 min-h-0 p-2">
            <p>Exercises:</p>
            <div className="d-flex flex-column flex-fill text-center overflow-y-scroll wp-100">
                ...
                props.exercises.map(exercise => 
                    <div className="d-flex flex-column" key={exercise.id}>
                        ...
                        <label htmlFor={`exercise-${props.k}-${exercise.id}`} className="btn btn-outline-secondary">{exercise.name}</label>
                    </div>
                    )}
